...
try {
  const page = await browser.newPage({ viewport: { width: 1280, height: 2000 }, deviceScaleFactor: 1, locale: 'zh-CN' });
  await page.goto(new URL('dataset/hec/', process.argv[2] || 'http://127.0.0.1:4321/').href);
